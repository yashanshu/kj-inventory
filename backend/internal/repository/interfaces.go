...
type ItemRepository interface {
	...
	ListWithFilters(ctx context.Context, orgID uuid.UUID, search string, categoryID *uuid.UUID, storeID *uuid.UUID, lowStockOnly bool, limit, offset int) ([]*domain.Item, error)
	CountWithFilters(ctx context.Context, orgID uuid.UUID, search string, categoryID *uuid.UUID, storeID *uuid.UUID, lowStockOnly bool) (int, error)
...
type StoreRepository interface {
	...
	SetPrimary(ctx context.Context, orgID, storeID uuid.UUID) error
